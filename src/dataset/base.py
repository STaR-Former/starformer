...
class BaseDataset(Dataset, ABC):
    ...
    def store_asset(self, format: str='pickle', file_path: str=None, obj: object=None, write: str='w') -> None:
        """
        Stores an object to a file in the specified format.
    ...
    def load_asset(self, format: str='pickle', file_path: str=None, buffer: bool=False, read: str='r') -> object:
        """
        Loads an object from a file in the specified format.
    ...
    def set_data(self) -> None:
        ...
        """
        assert isinstance(self._data[0], BaseData)
